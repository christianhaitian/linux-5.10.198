...
#define TSK_STACK_CANARY 1176 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 2432 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 3400 /* offsetof(struct task_struct, thread.sctlr_user) */
